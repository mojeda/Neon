...
<div align="center" class="LaunchSetup">
	<div style="z-index: 140;padding-top:10px;" class="simplebox grid740">
       <div style="z-index: 130;" class="titleh"><div align="left"><h3>Welcome</h3></div>
            <div style="z-index: 120;" class="shortcuts-icons">	<a original-title="Close" class="shortcut tips" href="#"><img src="templates/blue_default/img/icons/shortcut/close.png" alt="icon" height="25" width="25"></a>	</div>
        </div>
