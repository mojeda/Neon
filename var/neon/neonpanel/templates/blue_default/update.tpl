<div align="center" class="UpdateHome">
	{%if Outdated == true}
		...
		<br><br>
		<a href="update.php?id=develop" class="button-green icon-button"><img src="img/icons/button/download.png" alt="icon" height="18" width="18"><span>Update To Development Edition</span></a>
	{%/if}
	{%if Outdated == false}
		Neon is up to date.
	{%/if}
